...
class InvitationsResource:
    ...
    def list(self, target_type: str, target_id: str) -> list[Invitation]:
        """
        ...
        ```
        """
        data = self._http.get(f"/api/v1/invitations/{target_type}/{target_id}")
    ...
    def delete(self, target_type: str, target_id: str, invitation_id: str) -> None:
        """
...
class AsyncInvitationsResource:
    ...
    async def list(self, target_type: str, target_id: str) -> list[Invitation]:
        """
        List all pending invitations for a target.
        ...
        ```
        """
        data = await self._http.get(f"/api/v1/invitations/{target_type}/{target_id}")
        return [Invitation.model_validate(item) for item in (data or [])]
    ...
    async def delete(
        self, target_type: str, target_id: str, invitation_id: str
    ) -> None:
        """
        Cancel and delete an invitation.
